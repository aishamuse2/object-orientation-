...
let favoriteThings = {
  ...
  food: "Pasta",
  person: "Brent Faiyaz",
  book: "How to kill a mocking bird ",
...
} const cat1 = new Cat ('Prince', 15,'grey')
...
class Wizard {
 ...
 this.favoriteSpell = favoriteSpell
  ...
  const wiz1 = new Wizard ('Mona', 19,"Invinsible")
wiz1.castSpell()
...
//Code Here
const phone1 = new Phone('Apple','iphone',285,'grey',1200)
const phone2 = new Phone ('Motorola','motoG stylus',128,'green',600)
const phone3 = new Phone('Samsung', 'galaxy',256,'blue',900)
...
//Code Here
const myFirstVehicle= new Vehicle (6,'black',60,000)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(2,'red',1000,'harley',true)
/*
...
//Code Here
const myFirstBoat = new boat( 12,'Black',60,000,'Carla', 'cruise',false)
/*
